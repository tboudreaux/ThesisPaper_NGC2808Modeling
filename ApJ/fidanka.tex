...
\begin{figure*}
	\centering
	\includegraphics[width=0.9\textwidth]{src/DensityMapDemo.png}
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{src/DensityBinsDemo.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{src/ExtractedIsoFit.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{src/DistributionOfErrors.pdf}
