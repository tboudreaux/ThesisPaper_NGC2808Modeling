...
\begin{figure*}
  \centering
  \includegraphics[width=0.9\textwidth]{src/BestFitResults.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{src/ClusterAnalysis.pdf}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.90\textwidth]{src/photometricOffset.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{src/HeliumMeanOffset.pdf}
